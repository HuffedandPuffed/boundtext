...
authors: [
    {
      ...
      name: "Colin Bamforth",
      initials: "CB",
      role: "Lead Nonfiction",
      bio: "Colin writes practical guides and character-led fiction.",
      note: "Find more at colinbamforth.com",
    ...
    },
    {
      ...
      initials: "AA",
      role: "Lead Fiction",
      bio: "Avery focuses on atmospheric storytelling.",
      note: "Based in the UK.",
    ...
    },
    {
      ...
      name: "Russell Reader",
      initials: "RR",
      role: "Word Search Specialist",
      bio: "Russell compiles challenging and fun word puzzles.",
      note: "New collections released quarterly.",
