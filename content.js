...
window.HP_CONTENT = {
  ...
  authors: [
    {
      ...
      initials: "CB",
      bio:
        "Colin Bamforth is the visionary behind Huffed and Puffed Publishing. Operating at the intersection of structure and creativity, 
        Colin is a dedicated practical fiction and non-fiction author and puzzle-book creator. 
        Driven by a mission to champion human voices and amplify 'useful sparks,' he curates and designs books that engage the mind, challenge curious readers, and bring high-quality independent publishing to life."
    },
    {
      id: "avery-solene",
      name: "Avery Solene",
      ...
      initials: "AS",
      bio:
        "Born in Paris and previously based in the United Kingdom, Avery Solene has called Quebec, Canada home for the last eight years. 
        Having transitioned from a multi-year background in the adult entertainment industry into a senior corporate executive role for a massive multi-national retail company, Avery writes with a profound, 
        completely unfiltered understanding of reinvention, modern commerce, and the complex layers of human nature."
    },
    {
      id: "russell-bruce",
      name: "Russell Bruce",
      ...
      initials: "RB",
      bio:
        "Russell Bruce is a retired physics lecturer from the United Kingdom who has pursued creative writing as a passionate hobby since his late twenties. 
        Infusing his narratives with the analytical precision of a scientist alongside the warmth of a lifelong storyteller, 
        Russell crafts sharp-edged fiction that explores the intricate mechanics of human relationships and the wonders of the everyday world."
    }
  ],
  ...
  books: [
    ...
    },
    {
      ...
      description:
        "A practical Australia and New Zealand edition for readers facing burnout, transition, grief, overload, or uncertainty. This is not a book of quick fixes or forced positivity, but a grounded guide to walking with stress, using small repeatable steps to restore balance, clarity, and meaning."
    },
    {
      ...
      description:
        "A themed word-search collection for motorcycle enthusiasts, built for relaxed concentration and easy gifting."
    },
    {
      ...
      description:
        "A construction-themed puzzle book for readers who enjoy site language, tools, trades, and a satisfying pencil-and-paper break."
    },
    {
      ...
      description:
        "A quiet catch for puzzle fans, built around fishing terms, tackle, waters, and the easy rhythm of a good word search."
    },
    {
      ...
      description:
        "A bold adult-fiction journey into dominance, submission, and the pleasure of letting go. When a younger man is chosen by Vicky, a sophisticated and commanding woman twenty years his senior, one unforgettable dinner opens into a secret world of rules, restraint, trust, and awakening."
    },
    {
      ...
      description:
        "The final chapter in the Lessons series brings Mark, Vicky, and their intimate circle to a charged conclusion. With old loyalties shifting and new roles emerging, Lessons in Control explores sexual sovereignty, lasting love, and the exquisite tension between dominance and surrender."
    },
    {
      ...
      description:
        "Mark and Vicky live inside an open relationship built on power, consent, and absolute trust. At The Vicarage, pleasure is curated and loyalty is earned, but past lovers, new temptations, and personal business begin to blur the line between ownership and intimacy."
    },
    {
      ...
      description:
        "Mark and Vicky return more open, exposed, and connected than ever. From private weekends to acts of surrender behind closed doors, this third Lessons title asks what happens when dominance meets devotion and pleasure demands truth."
    },
    {
      ...
      description:
        "Book one in the Imogen series. Imogen is eighteen, brilliant, and determined to live on her own terms. At university she studies design, psychology, people, pleasure, and power, learning that every encounter can become a test of control."
    },
    {
      ...
      description:
        "Desire is easy. Control takes skill. In London, Imogen Hartley moves through galleries, lecture halls, private penthouses, and blurred boundaries, refining the art of influence while deciding whether control is freedom or another form of restraint."
    },
    {
      ...
      description:
        "Power is neither hard nor soft. It is both: brass and silk. From Paris to Milan, Imogen no longer studies desire; she orchestrates it, balancing architecture, art, ambition, devotion, rivalry, and the cost of mastering everything around her."
    },
    {
      ...
      description:
        "Based strongly on lived events, Calculated Encounters follows Aveline from a fading seaside hotel bar into a world of boundaries, discretion, strategy, and survival. Part erotic realism and part diary of ambition, it is a bold exploration of autonomy, risk, control, and the hidden currencies of power."
    }
  ],
  ...
  privatePage: {
    ...
    warning:
      "This prototype password gate is client-side only. It is useful for drafts and convenience, but not for genuinely private files. Real file management should use server-side authentication."
  }
};
