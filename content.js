  ...
  authors: [
    {
      ...
      initials: "CB",
      bio:
        "Colin Bamforth writes practical, accessible books for readers who want useful ideas without being talked down to. His publishing list moves between stress, work, hobbies, and puzzle-led downtime, with a steady interest in making complex days feel more manageable.",
      note: "Full biography, photo, and genre positioning to be supplied later."
    },
    {
      id: "avery-solene",
      name: "Avery Solene",
      ...
      initials: "AS",
      bio:
        "Avery Solene writes intimate, controlled fiction about desire, ambition, risk, and the private negotiations people make with power. Her work is direct, character-led, and designed for readers who like emotional stakes with polished edges.",
      note: "Placeholder biography pending final author details."
    },
    {
      id: "russell-bruce",
      name: "Russell Bruce",
      ...
      initials: "RB",
      bio:
        "Russell Bruce writes adult fiction about surrender, control, trust, loyalty, and the arrangements people enter when longing meets consequence. His books lean into tension, consent, and the uneasy bargain between secrecy and devotion.",
      note: "Placeholder biography pending final author details."
    }
  ],
